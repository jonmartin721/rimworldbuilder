...
def find_bridges_everywhere():
    ...
    bridge_terrain_types = [
        'BridgeHeavy', 'Bridge_Heavy', 'HeavyBridge',
        'BridgeSteel', 'Bridge_Steel', 'SteelBridge',
        'BridgeWood', 'Bridge_Wood', 'WoodBridge',
        'BridgeConcrete', 'ConcreteBridge',
        'TerrainBridge', 'Floor_Bridge'
    ]
