    ...
    if terrain_grid is not None:
        ...
        if top_grid is not None and top_grid.text:
            ...
            for byte_val, count in common_bytes:
                print(f"  0x{byte_val:02x}: {count} times ({count/len(decompressed)*100:.1f}%)")
            ...
            terrain_keywords = ['Soil', 'Sand', 'Water', 'Bridge', 'Stone', 'Marsh', 'Gravel', 
                              'Floor', 'Concrete', 'Tile', 'Wood', 'Steel', 'Heavy']
