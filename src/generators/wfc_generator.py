...
class WFCGenerator:
    ...
    def _create_adjacency_rules(self) -> Dict[TileType, Dict[str, Set[TileType]]]:
        ...
        rules[TileType.DOOR] = {
            'north': {TileType.CORRIDOR, TileType.BEDROOM, TileType.STORAGE, TileType.WORKSHOP, 
                     TileType.KITCHEN, TileType.DINING, TileType.HOSPITAL, TileType.RESEARCH},
            'south': {TileType.CORRIDOR, TileType.BEDROOM, TileType.STORAGE, TileType.WORKSHOP,
                     TileType.KITCHEN, TileType.DINING, TileType.HOSPITAL, TileType.RESEARCH},
            'east': {TileType.WALL},
            'west': {TileType.WALL}
        }
        ...
        rules[TileType.STORAGE] = {
            'north': {TileType.WALL, TileType.DOOR, TileType.STORAGE, TileType.WORKSHOP, TileType.CORRIDOR},
            'south': {TileType.WALL, TileType.DOOR, TileType.STORAGE, TileType.WORKSHOP, TileType.CORRIDOR},
            'east': {TileType.WALL, TileType.DOOR, TileType.STORAGE, TileType.WORKSHOP, TileType.CORRIDOR},
            'west': {TileType.WALL, TileType.DOOR, TileType.STORAGE, TileType.WORKSHOP, TileType.CORRIDOR}
        }
        
        # Workshop rules - needs storage nearby, power access
        rules[TileType.WORKSHOP] = {
            'north': {TileType.WALL, TileType.DOOR, TileType.WORKSHOP, TileType.STORAGE, TileType.CORRIDOR},
            'south': {TileType.WALL, TileType.DOOR, TileType.WORKSHOP, TileType.STORAGE, TileType.CORRIDOR},
            'east': {TileType.WALL, TileType.DOOR, TileType.WORKSHOP, TileType.STORAGE, TileType.CORRIDOR},
            'west': {TileType.WALL, TileType.DOOR, TileType.WORKSHOP, TileType.STORAGE, TileType.CORRIDOR}
        }
        
        # Kitchen rules - should be near dining and storage
        rules[TileType.KITCHEN] = {
            'north': {TileType.WALL, TileType.DOOR, TileType.KITCHEN, TileType.DINING, TileType.STORAGE},
            'south': {TileType.WALL, TileType.DOOR, TileType.KITCHEN, TileType.DINING, TileType.STORAGE},
            'east': {TileType.WALL, TileType.DOOR, TileType.KITCHEN, TileType.DINING, TileType.STORAGE},
            'west': {TileType.WALL, TileType.DOOR, TileType.KITCHEN, TileType.DINING, TileType.STORAGE}
        }
        
        # Dining rules - should be near kitchen and recreation
        rules[TileType.DINING] = {
            'north': {TileType.WALL, TileType.DOOR, TileType.DINING, TileType.KITCHEN, TileType.RECREATION},
            'south': {TileType.WALL, TileType.DOOR, TileType.DINING, TileType.KITCHEN, TileType.RECREATION},
            'east': {TileType.WALL, TileType.DOOR, TileType.DINING, TileType.KITCHEN, TileType.RECREATION},
            'west': {TileType.WALL, TileType.DOOR, TileType.DINING, TileType.KITCHEN, TileType.RECREATION}
        }
        ...
        rules[TileType.POWER] = {
            'north': {TileType.WALL, TileType.POWER, TileType.BATTERY, TileType.WORKSHOP, TileType.EMPTY},
            'south': {TileType.WALL, TileType.POWER, TileType.BATTERY, TileType.WORKSHOP, TileType.EMPTY},
            'east': {TileType.WALL, TileType.POWER, TileType.BATTERY, TileType.WORKSHOP, TileType.EMPTY},
            'west': {TileType.WALL, TileType.POWER, TileType.BATTERY, TileType.WORKSHOP, TileType.EMPTY}
        }
    ...
    def generate(self, buildable_positions: Optional[Set[Tuple[int, int]]] = None) -> bool:
        """
            ...
            for y in range(self.height):
                for x in range(self.width):
                    if (x, y) not in buildable_positions:
                        ...
                        self.grid[y][x].possible_types = {TileType.EMPTY, TileType.OUTDOOR}
