...
class RimWorldBestPractices:
    ...
    ROOM_CONFIGS = {
        ModConfig.VANILLA: {
            "bedroom": RoomDimensions(
                min_tiles=12, standard_tiles=20, good_tiles=30, max_practical_tiles=36,
                min_dims=(3, 4), standard_dims=(4, 5), good_dims=(5, 6), max_dims=(6, 6)
            ),
            "dining": RoomDimensions(
                min_tiles=29, standard_tiles=40, good_tiles=55, max_practical_tiles=70,
                min_dims=(5, 6), standard_dims=(6, 7), good_dims=(7, 8), max_dims=(8, 9)
            ),
            "workshop": RoomDimensions(
                min_tiles=29, standard_tiles=49, good_tiles=64, max_practical_tiles=81,
                min_dims=(5, 6), standard_dims=(7, 7), good_dims=(8, 8), max_dims=(9, 9)
            ),
            "hospital": RoomDimensions(
                min_tiles=20, standard_tiles=30, good_tiles=42, max_practical_tiles=56,
                min_dims=(4, 5), standard_dims=(5, 6), good_dims=(6, 7), max_dims=(7, 8)
            ),
            "recreation": RoomDimensions(
                min_tiles=29, standard_tiles=42, good_tiles=56, max_practical_tiles=72,
                min_dims=(5, 6), standard_dims=(6, 7), good_dims=(7, 8), max_dims=(8, 9)
            ),
            ...
            "storage": RoomDimensions(
                min_tiles=29, standard_tiles=49, good_tiles=81, max_practical_tiles=121,
                min_dims=(5, 6), standard_dims=(7, 7), good_dims=(9, 9), max_dims=(11, 11)
            ),
            "research": RoomDimensions(
                min_tiles=20, standard_tiles=30, good_tiles=42, max_practical_tiles=49,
                min_dims=(4, 5), standard_dims=(5, 6), good_dims=(6, 7), max_dims=(7, 7)
            ),
            "prison_cell": RoomDimensions(
                min_tiles=12, standard_tiles=16, good_tiles=20, max_practical_tiles=25,
                min_dims=(3, 4), standard_dims=(4, 4), good_dims=(4, 5), max_dims=(5, 5)
            ),
            "throne": RoomDimensions(
                min_tiles=55, standard_tiles=81, good_tiles=121, max_practical_tiles=169,
                min_dims=(7, 8), standard_dims=(9, 9), good_dims=(11, 11), max_dims=(13, 13)
            )
        },
        ModConfig.REALISTIC_ROOMS: {
            "bedroom": RoomDimensions(
                min_tiles=6, standard_tiles=12, good_tiles=16, max_practical_tiles=25,
                min_dims=(2, 3), standard_dims=(3, 4), good_dims=(4, 4), max_dims=(5, 5)
            ),
            "dining": RoomDimensions(
                min_tiles=12, standard_tiles=20, good_tiles=28, max_practical_tiles=45,
                min_dims=(3, 4), standard_dims=(4, 5), good_dims=(4, 7), max_dims=(5, 9)
            ),
            "workshop": RoomDimensions(
                min_tiles=12, standard_tiles=28, good_tiles=45, max_practical_tiles=75,
                min_dims=(3, 4), standard_dims=(4, 7), good_dims=(5, 9), max_dims=(7, 11)
            ),
            "hospital": RoomDimensions(
                min_tiles=12, standard_tiles=20, good_tiles=28, max_practical_tiles=45,
                min_dims=(3, 4), standard_dims=(4, 5), good_dims=(4, 7), max_dims=(5, 9)
            ...
            "kitchen": RoomDimensions(
                min_tiles=6, standard_tiles=12, good_tiles=16, max_practical_tiles=20,
                min_dims=(2, 3), standard_dims=(3, 4), good_dims=(4, 4), max_dims=(4, 5)
            ),
            "storage": RoomDimensions(
                min_tiles=12, standard_tiles=28, good_tiles=45, max_practical_tiles=75,
                min_dims=(3, 4), standard_dims=(4, 7), good_dims=(5, 9), max_dims=(7, 11)
            ...
            "research": RoomDimensions(
                min_tiles=12, standard_tiles=16, good_tiles=20, max_practical_tiles=28,
                min_dims=(3, 4), standard_dims=(4, 4), good_dims=(4, 5), max_dims=(4, 7)
            ),
            "prison_cell": RoomDimensions(
                min_tiles=6, standard_tiles=9, good_tiles=12, max_practical_tiles=16,
                min_dims=(2, 3), standard_dims=(3, 3), good_dims=(3, 4), max_dims=(4, 4)
            ),
            "throne": RoomDimensions(
                min_tiles=28, standard_tiles=45, good_tiles=75, max_practical_tiles=100,
                min_dims=(4, 7), standard_dims=(5, 9), good_dims=(7, 11), max_dims=(10, 10)
            )
        },
        ModConfig.REALISTIC_ROOMS_LITE: {
            "bedroom": RoomDimensions(
                min_tiles=9, standard_tiles=16, good_tiles=20, max_practical_tiles=30,
                min_dims=(3, 3), standard_dims=(4, 4), good_dims=(4, 5), max_dims=(5, 6)
            ),
            "dining": RoomDimensions(
                min_tiles=20, standard_tiles=30, good_tiles=45, max_practical_tiles=60,
                min_dims=(4, 5), standard_dims=(5, 6), good_dims=(5, 9), max_dims=(6, 10)
            ),
            "workshop": RoomDimensions(
                min_tiles=20, standard_tiles=36, good_tiles=49, max_practical_tiles=64,
                min_dims=(4, 5), standard_dims=(6, 6), good_dims=(7, 7), max_dims=(8, 8)
            ),
            "hospital": RoomDimensions(
                min_tiles=16, standard_tiles=25, good_tiles=36, max_practical_tiles=49,
                min_dims=(4, 4), standard_dims=(5, 5), good_dims=(6, 6), max_dims=(7, 7)
            ),
            "recreation": RoomDimensions(
                min_tiles=20, standard_tiles=30, good_tiles=45, max_practical_tiles=60,
                min_dims=(4, 5), standard_dims=(5, 6), good_dims=(5, 9), max_dims=(6, 10)
            ...
            "kitchen": RoomDimensions(
                min_tiles=9, standard_tiles=16, good_tiles=20, max_practical_tiles=25,
                min_dims=(3, 3), standard_dims=(4, 4), good_dims=(4, 5), max_dims=(5, 5)
            ),
            "storage": RoomDimensions(
                min_tiles=20, standard_tiles=36, good_tiles=64, max_practical_tiles=100,
                min_dims=(4, 5), standard_dims=(6, 6), good_dims=(8, 8), max_dims=(10, 10)
            ),
            "research": RoomDimensions(
                min_tiles=16, standard_tiles=20, good_tiles=25, max_practical_tiles=36,
                min_dims=(4, 4), standard_dims=(4, 5), good_dims=(5, 5), max_dims=(6, 6)
            ),
            "prison_cell": RoomDimensions(
                min_tiles=9, standard_tiles=12, good_tiles=16, max_practical_tiles=20,
                min_dims=(3, 3), standard_dims=(3, 4), good_dims=(4, 4), max_dims=(4, 5)
            ),
            "throne": RoomDimensions(
                min_tiles=45, standard_tiles=64, good_tiles=100, max_practical_tiles=144,
                min_dims=(5, 9), standard_dims=(8, 8), good_dims=(10, 10), max_dims=(12, 12)
            )
        }
    }
    ...
    @staticmethod
    def get_room_dimensions(room_type: str, 
                           mod_config: ModConfig = ModConfig.REALISTIC_ROOMS,
                           size_preference: str = "standard") -> Tuple[int, int]:
        """
    ...
    @staticmethod
    def validate_base_layout(grid: np.ndarray, rooms: List[Dict]) -> Dict[str, List[str]]:
        """
        ...
        if bedroom_positions:
            ...
            for bedroom in bedroom_positions:
                dist_to_center = abs(bedroom['y'] - center_y) + abs(bedroom['x'] - center_x)
                if dist_to_center < min(grid.shape) // 4:
                    warnings.append("Bedroom placed too centrally - should be on colony edges")
                    break
        ...
        if hospital:
            ...
            edge_dist = min(hospital['x'], hospital['y'], 
                          grid.shape[1] - hospital['x'], grid.shape[0] - hospital['y'])
            if edge_dist > 10:
        ...
        if len(workshops) > 1:
            ...
            if count > 0 and total_dist / count > 10:
                suggestions.append("Workshops should be clustered together for efficiency")
        ...
        for y in range(height - 5, height):
            for x in range(width):
                if x == 0 or x == width - 1 or y == height - 1:
                    killbox[y, x] = TileType.WALL
                elif (x % specs["turret_spacing"] == 0 and 
                      y == height - 3 and 
                      2 < x < width - 3):
